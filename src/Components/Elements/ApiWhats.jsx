  ...
  return (
    <div
      dangerouslySetInnerHTML={{
        // __html: `<a onclick="gtag_report_conversion('https://api.whatsapp.com/send?phone=5541999078107');"
        __html: `<a
            href="https://api.whatsapp.com/send?phone=5541999078107" 
            class='float'
            target='_blank'>
            <svg class="svg-shadow" height="60%" width="60%" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
